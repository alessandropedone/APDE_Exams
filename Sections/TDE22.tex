...
\[
    ...
    \end{split}
\]
Since \(\sin\left(\rho\right) \overset{\rho \to 0}{\longrightarrow} \rho\) we have that the integral is finite if
\[
    \begin{split}
        \int_0^1 \abs{\frac{\rho}{\rho^{3p}} \rho^{n-1}} \, d\rho < \infty \iff 3p - n + 1 - 1 < 1 \iff 1 \leq p < \frac{n - 1}{3} \Rightarrow n \geq 5
    \end{split}
\]
...
\[
    ...
    \end{split}
\]
Also in this case we have \(\cos\left(\abs{\rho}\right) \abs{\rho} - 3 \sin\left(\abs{\rho}\right) \overset{\rho \to 0}{\longrightarrow} -2\rho\), so we need that
\[
    \begin{split}
        \int_0^1 \abs{\frac{-2\rho} {\rho^{4p}} \rho^{n-1}} \, d\rho < \infty \iff 4p - n + 1 - 1< 1 \iff 1 \leq p < \frac{n - 1}{4} \Rightarrow n \geq 6
    \end{split}
\]
...
\[
    \begin{split}
        ...
        = \max_{\partial B_\epsilon} \abs{\phi} \int_{\{ \norm{x} = \epsilon \}} \abs{\frac{\sin\left(\abs{x}\right)}{\abs{x}^3}} \, d\sigma = \max_{\partial B_\epsilon} \abs{\phi}  \abs{\frac{\sin\left(\epsilon\right)}{\epsilon^3}} \mu\left\{\norm{x} = \epsilon\right\} \leq \max_{\partial B_\epsilon} \abs{\phi} \frac{\epsilon}{\epsilon^3} \epsilon^{n-1} = \\ 
    \end{split}
\]
We have that 
\[
    \begin{split}
        \lim_{\epsilon \to 0^+} \max_{\partial B_\epsilon} \abs{\phi} \frac{\epsilon}{\epsilon^3} \epsilon^{n-1} = \lim_{\epsilon \to 0^+} \max_{\partial B_\epsilon} \abs{\phi} \epsilon^{n-3} = 0 \text{ since } n \geq 4
    \end{split}
\]

So we have shown that \(f \in W^{1, p}(B) \iff n > 5 \land 1 \leq p < \frac{n}{4}\).
