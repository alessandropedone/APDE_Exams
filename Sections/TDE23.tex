...
We start by assuming that there are two solutions \(u_1\) and \(u_2\). We define \(w = u_1 - u_2\). We have that \(w\) satisfies the homogeneous beam equation
\[
    \begin{cases}
...
\end{align*}
Probably wrong not going to do all this calculations if you manage to solve it pleas correct it. Assuming \(\grad f \in L^2(\Omega)\).
